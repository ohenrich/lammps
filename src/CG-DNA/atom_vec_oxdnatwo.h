...
#ifdef ATOM_CLASS
// clang-format off
AtomStyle(oxdnatwo,AtomVecOxdna);
// clang-format on
#else

#ifndef LMP_ATOM_VEC_OXDNATWO_H
#define LMP_ATOM_VEC_OXDNATWO_H

#include "atom_vec_oxdna.h"

namespace LAMMPS_NS {

class AtomVecOxdnaTwo : public AtomVecOxdna {
 public:
  AtomVecOxdnaTwo(class LAMMPS *);
  virtual ~AtomVecOxdnaTwo();
