...
PairOxdnaXstk::PairOxdnaXstk(LAMMPS *lmp) :
    ...
    dtheta_xst3_c(nullptr), a_xst4(nullptr), theta_xst4_0(nullptr), dtheta_xst4_ast(nullptr),
    b_xst4(nullptr), dtheta_xst4_c(nullptr), a_xst7(nullptr), theta_xst7_0(nullptr),
    dtheta_xst7_ast(nullptr), b_xst7(nullptr), dtheta_xst7_c(nullptr), a_xst8(nullptr),
    theta_xst8_0(nullptr), dtheta_xst8_ast(nullptr), b_xst8(nullptr), dtheta_xst8_c(nullptr),
...
------------------------------------------------------------------------ */
inline void PairOxdnaXstk::compute_base_site(int /*type*/, double e1[3],
...
void PairOxdnaXstk::compute(int eflag, int vflag)
{
  ...
  double df4t4_1,df4t4_2,df4t7_1,df4t7_2,df4t8_1,df4t8_2;
  ...
  for (ia = 0; ia < anum; ia++) {
    ...
    for (ib = 0; ib < bnum; ib++) {
      ...
      f2 = F2(r_bsbs, k_xst[atype][btype], cut_xst_0[atype][btype], cut_xst_lc[atype][btype],
              cut_xst_hc[atype][btype], cut_xst_lo[atype][btype], cut_xst_hi[atype][btype],
              b_xst_lo[atype][btype], b_xst_hi[atype][btype], cut_xst_c[atype][btype], df2);
      ...
      f4t4 = F4(theta4, a_xst4[atype][btype], theta_xst4_0[atype][btype], dtheta_xst4_ast[atype][btype],
                b_xst4[atype][btype], dtheta_xst4_c[atype][btype], df4t4_1) +
             F4(theta4p, a_xst4[atype][btype], theta_xst4_0[atype][btype], dtheta_xst4_ast[atype][btype],
                b_xst4[atype][btype], dtheta_xst4_c[atype][btype], df4t4_2);
      ...
      f4t7 = F4(theta7, a_xst7[atype][btype], theta_xst7_0[atype][btype], dtheta_xst7_ast[atype][btype],
                b_xst7[atype][btype], dtheta_xst7_c[atype][btype], df4t7_1) +
             F4(theta7p, a_xst7[atype][btype], theta_xst7_0[atype][btype], dtheta_xst7_ast[atype][btype],
                b_xst7[atype][btype], dtheta_xst7_c[atype][btype], df4t7_2);
      ...
      f4t8 = F4(theta8, a_xst8[atype][btype], theta_xst8_0[atype][btype], dtheta_xst8_ast[atype][btype],
                b_xst8[atype][btype], dtheta_xst8_c[atype][btype], df4t8_1) +
             F4(theta8p, a_xst8[atype][btype], theta_xst8_0[atype][btype], dtheta_xst8_ast[atype][btype],
                b_xst8[atype][btype], dtheta_xst8_c[atype][btype], df4t8_2);
      ...
      df4t4 = (df4t4_1 - df4t4_2)/sin(theta4);

      df4t7 = (df4t7_1 - df4t7_2)/sin(theta7);

      df4t8 = (df4t8_1 - df4t8_2)/sin(theta8);
      ...
      // radial force
      finc  = -df2 * f4t1 * f4t2 * f4t3 * f4t4 * f4t7 * f4t8 * rinv_bsbs *factor_lj;
      ...
      if (theta2 != 0.0) {
        ...
        finc  = -f2 * f4t1 * df4t2 * f4t3 * f4t4 * f4t7 * f4t8 * rinv_bsbs * factor_lj;
      ...
      if (theta3 != 0.0) {
        ...
        finc  = -f2 * f4t1 * f4t2 * df4t3 * f4t4 * f4t7 * f4t8 * rinv_bsbs * factor_lj;
      ...
      if (theta7 != 0.0) {
        ...
        finc  = -f2 * f4t1 * f4t2 * f4t3 * f4t4 * df4t7 * f4t8 * rinv_bsbs * factor_lj;
      ...
      if (theta8 != 0.0) {
        ...
        finc  = -f2 * f4t1 * f4t2 * f4t3 * f4t4 * f4t7 * df4t8 * rinv_bsbs * factor_lj;
    ...
    for (j = i; j <= atom->ntypes; j++) {
      ...
      if (setflag[i][j]) {
        if (me == 0) {
          ...
          utils::sfread(FLERR,&a_xst4[i][j],sizeof(double),1,fp,nullptr,error);
          utils::sfread(FLERR,&theta_xst4_0[i][j],sizeof(double),1,fp,nullptr,error);
          utils::sfread(FLERR,&dtheta_xst4_ast[i][j],sizeof(double),1,fp,nullptr,error);
          utils::sfread(FLERR,&b_xst4[i][j],sizeof(double),1,fp,nullptr,error);
          utils::sfread(FLERR,&dtheta_xst4_c[i][j],sizeof(double),1,fp,nullptr,error);
