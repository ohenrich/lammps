...
#include "atom_vec_oxdnatwo.h"

using namespace LAMMPS_NS;

/* ---------------------------------------------------------------------- */

AtomVecOxdnaTwo::AtomVecOxdnaTwo(LAMMPS *lmp) : AtomVecOxdna(lmp)
{
...
AtomVecOxdnaTwo::~AtomVecOxdnaTwo() 
{
...
void AtomVecOxdnaTwo::compute_interaction_sites(double e1[3], double e2[3],
