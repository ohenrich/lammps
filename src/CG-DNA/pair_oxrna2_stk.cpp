...
void PairOxrna2Stk::compute(int eflag, int vflag)
{
  ...
  for (in = 0; in < nbondlist; in++) {
    ...
    cost9 = MathExtra::dot3(delr_bkbk_norm,aux3p);
    if (cost9 >  1.0) cost9 =  1.0;
    if (cost9 < -1.0) cost9 = -1.0;
    theta9 = acos(cost9);

    cost10 = MathExtra::dot3(delr_bkbk_norm,aux5p);
    ...
    f4t9 = FF4(theta9, a_st9[atype][btype], theta_st9_0[atype][btype], dtheta_st9_ast[atype][btype],
        b_st9[atype][btype], dtheta_st9_c[atype][btype], df4t9);

    f4t10 = FF4(theta10, a_st10[atype][btype], theta_st10_0[atype][btype], dtheta_st10_ast[atype][btype],
    ...
    if (theta9 != 0.0) {
      ...
      MathExtra::cross3(delr_bkbk_norm,aux3p,t9dir);
    ...
    if (theta10 != 0.0) {
      ...
      MathExtra::cross3(delr_bkbk_norm,aux5p,t10dir);
