...
void PairOxdnaStkKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  ...
  if (evflag) {
    if (newton_bond) {
      if (oxdnaflag==OXDNA) {
        Kokkos::parallel_reduce(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA,1,1> >(0,nbondlist),*this,ev);
      } else if (oxdnaflag==OXDNA3) {
        Kokkos::parallel_reduce(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA3,1,1> >(0,nbondlist),*this,ev);
      }
    } else {
      if (oxdnaflag==OXDNA) {
        Kokkos::parallel_reduce(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA,0,1> >(0,nbondlist),*this,ev);
      } else if (oxdnaflag==OXDNA3) {
        Kokkos::parallel_reduce(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA3,0,1> >(0,nbondlist),*this,ev);
      }
    }
  } else {
    if (newton_bond) {
      if (oxdnaflag==OXDNA) {
        Kokkos::parallel_for(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA,1,0> >(0,nbondlist),*this);
      } else if (oxdnaflag==OXDNA3) {
        Kokkos::parallel_for(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA3,1,0> >(0,nbondlist),*this);
      }
    } else {
      if (oxdnaflag==OXDNA) {
        Kokkos::parallel_for(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA,0,0> >(0,nbondlist),*this);
      } else if (oxdnaflag==OXDNA3) {
        Kokkos::parallel_for(OxdnaRangePolicy<DeviceType, TagPairOxdnaStkCompute<OXDNA3,0,0> >(0,nbondlist),*this);
      }
    }
  }
