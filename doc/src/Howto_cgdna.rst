Coarse-grained nucleic acids with CG-DNA
========================================

Coarse-grained simulations of nucleic acids (DNA, RNA and DNA:RNA hybrid)
are enabled by the :ref:`CG-DNA <PKG-CG-DNA>` package.
...
In the DNA:RNA hybrid oxDNA2 and oxRNA2 force fields are used for each
sub-model.
